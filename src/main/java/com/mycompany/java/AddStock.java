...
public class AddStock extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product ID", "Product Name", "Category", "Retail Price", "Wholesale Price", "Description", "Active Status"
            }
        ) {
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
            ...
            con=DBConnect.connect();
            String sql1 = "select * from stock where productID = '"+productID+"'";
            pst = con.prepareStatement(sql1);
            rs=pst.executeQuery();
            String sql2;
            if(rs.next()){
                 sql2= "UPDATE stock SET amountInStock = amountInStock + '"+amount+"' where productID = '"+productID+"'";      
            }
            else{
                 sql2 = "insert into stock (productID,amountInStock) values('"+productID+"','"+amount+"')";
           ...
           String sql4 = "insert into stockhistory  (productID,name,amount,action,date,time) values ('"+productID+"','"+name+"','"+amount+"','ADDED','"+strDate+"','"+strTime+"')";
            ...
            jTextField3.setText("");
            jTextField4.setText("");
            String text = jTextArea1.getText()+"\n"+amount+" new items added to the stock ID ="+productID+" Name ="+name;
       ...
       String name = jTextField1.getText();
        ...
        if(Category.equals("Select Category")){
            ...
            try {
                ...
                String sql = "select * from products where name Like '%"+name+"%' AND category ='"+Category+"'";
                pst = con.prepareStatement(sql);
                rs = pst.executeQuery();
                DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                model.setRowCount(0);
