...
public class LowOnStock extends javax.swing.JInternalFrame {
     ...
     public void tableload(){
        try {
            ...
            String sql = "select products.productID,products.name,products.category,stock.amountInStock,products.retailPrice,products.wholesalePrice,products.description,products.activate "
                    + "From products INNER JOIN stock ON products.productID = stock.productID AND stock.amountInStock < 10";
            ...
            Logger.getLogger(LowOnStock.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
       try {
            ...
            con=DBConnect.connect();
            String sql = "select products.productID,products.name,products.category,stock.amountInStock,products.retailPrice,products.wholesalePrice,products.description,products.activate "
                    + "     From products INNER JOIN stock ON products.productID = stock.productID AND products.category ='"+Category+"' AND stock.amountInStock < 10";
